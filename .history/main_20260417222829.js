...
const DB={
  projects:[
    {id:1,name:{ar:"مشروع سلسلة التوزيع الوطنية",en:"National Distribution Chain"},desc:{ar:"إدارة شاملة لسلسلة التوزيع.",en:"Comprehensive distribution chain management."},client:"شركة التجزئة الوطنية",duration:{ar:"8 أشهر",en:"8 months"},status:"completed",icon:"🏬",img:""},
    {id:2,name:{ar:"المستودع الذكي - الرياض",en:"Smart Warehouse - Riyadh"},desc:{ar:"مستودع ذكي بأنظمة تتبع متقدمة.",en:"Smart warehouse with advanced tracking systems."},client:"مجموعة الأعمال الخليجية",duration:{ar:"12 شهر",en:"12 months"},status:"ongoing",icon:"🚀",img:""},
    {id:3,name:{ar:"التوصيل السريع للتجارة الإلكترونية",en:"E-commerce Fast Delivery"},desc:{ar:"شراكة لتوصيل 5000 طلب يومياً.",en:"Partnership delivering 5000 orders daily."},client:"منصة رائدة",duration:{ar:"6 أشهر",en:"6 months"},status:"completed",icon:"📱",img:""},
    {id:4,name:{ar:"لوجستيات القطاع الصحي",en:"Healthcare Logistics"},desc:{ar:"خدمات لوجستية للمستشفيات.",en:"Logistics services for hospitals."},client:"مجموعة المستشفيات",duration:{ar:"18 شهر",en:"18 months"},status:"ongoing",icon:"🏥",img:""}
  ],
  news:[
    {id:1,title:{ar:"رعاية تُطلق أسطول توصيل كهربائي",en:"Riaya Launches Electric Delivery Fleet"},excerpt:{ar:"في إطار التزامنا بالاستدامة ورؤية 2030...",en:"As part of our commitment to sustainability and Vision 2030..."},cat:{ar:"إعلان",en:"Announcement"},date:"2026-04-15",icon:"📢",img:""},
    {id:2,title:{ar:"شراكة استراتيجية مع كبرى شركات الخليج",en:"Strategic Partnership with Gulf Majors"},excerpt:{ar:"أبرمت رعاية اتفاقية شراكة استراتيجية...",en:"Riaya signed a strategic partnership agreement..."},cat:{ar:"شراكة",en:"Partnership"},date:"2026-03-01",icon:"🤝",img:""},
    {id:3,title:{ar:"رعاية تفوز بجائزة أفضل شركة لوجستية",en:"Riaya Wins Best Logistics Company Award"},excerpt:{ar:"تشرفت رعاية بالفوز بجائزة أفضل شركة...",en:"Riaya was honored with the Best Logistics Company award..."},cat:{ar:"جائزة",en:"Award"},date:"2026-02-10",icon:"🏆",img:""}
  ],
  team:[
    {id:1,name:{ar:"أحمد العلي",en:"Ahmed Al-Ali"},role:{ar:"المدير التنفيذي",en:"CEO"},bio:{ar:"خبرة أكثر من 15 عاماً في اللوجستيات.",en:"15+ years of logistics expertise."},icon:"👨‍💼",img:""},
    {id:2,name:{ar:"سارة المنصور",en:"Sara Al-Mansour"},role:{ar:"مديرة العمليات",en:"Operations Director"},bio:{ar:"متخصصة في تحسين سلاسل الإمداد.",en:"Supply chain optimization specialist."},icon:"👩‍💼",img:""},
    {id:3,name:{ar:"خالد الشمري",en:"Khalid Al-Shammari"},role:{ar:"مدير تقنية المعلومات",en:"IT Manager"},bio:{ar:"خبير في أنظمة التتبع والإدارة.",en:"Expert in tracking and management systems."},icon:"👨‍💻",img:""},
    {id:4,name:{ar:"نورة القحطاني",en:"Noura Al-Qahtani"},role:{ar:"مديرة الموارد البشرية",en:"HR Manager"},bio:{ar:"متخصصة في إدارة القوى العاملة.",en:"Workforce management specialist."},icon:"👩‍💼",img:""}
  ],
  jobs:[
    {id:1,title:{ar:"مشرف مستودعات",en:"Warehouse Supervisor"},dept:{ar:"العمليات",en:"Operations"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},salary:{ar:"8,000 - 12,000 ر.س",en:"8,000 - 12,000 SAR"},icon:"🏭"},
    {id:2,title:{ar:"سائق توصيل",en:"Delivery Driver"},dept:{ar:"التوصيل",en:"Delivery"},loc:{ar:"جدة",en:"Jeddah"},type:{ar:"دوام كامل",en:"Full-time"},salary:{ar:"5,000 - 7,000 ر.س",en:"5,000 - 7,000 SAR"},icon:"🚚"},
    {id:3,title:{ar:"منسق لوجستي",en:"Logistics Coordinator"},dept:{ar:"اللوجستيات",en:"Logistics"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},salary:{ar:"9,000 - 14,000 ر.س",en:"9,000 - 14,000 SAR"},icon:"📋"},
    {id:4,title:{ar:"مسؤول موارد بشرية",en:"HR Officer"},dept:{ar:"الموارد البشرية",en:"HR"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},salary:{ar:"7,000 - 10,000 ر.س",en:"7,000 - 10,000 SAR"},icon:"👥"}
  ],
  gallery:[
    {id:1,title:{ar:"مستودع الرياض",en:"Riyadh Warehouse"},cat:"warehouse",icon:"🏭",img:""},
    {id:2,title:{ar:"أسطول التوصيل",en:"Delivery Fleet"},cat:"delivery",icon:"🚚",img:""},
    {id:3,title:{ar:"فريق العمل",en:"Our Team"},cat:"team",icon:"👥",img:""},
    {id:4,title:{ar:"مركز الفرز",en:"Sorting Center"},cat:"warehouse",icon:"📦",img:""},
    {id:5,title:{ar:"عمليات التوصيل",en:"Delivery Operations"},cat:"delivery",icon:"🛵",img:""},
    {id:6,title:{ar:"اجتماع الفريق",en:"Team Meeting"},cat:"team",icon:"🤝",img:""}
  ],
  partners:[
    {id:1,name:{ar:"مجموعة الخليج",en:"Gulf Group"},type:{ar:"شريك لوجستي",en:"Logistics Partner"},icon:"🏢"},
    {id:2,name:{ar:"الصناعات الوطنية",en:"National Industries"},type:{ar:"شريك تشغيلي",en:"Operational Partner"},icon:"🏭"},
    {id:3,name:{ar:"منصة التجارة",en:"Commerce Platform"},type:{ar:"شريك توصيل",en:"Delivery Partner"},icon:"🛒"},
    {id:4,name:{ar:"القطاع الصحي",en:"Healthcare Sector"},type:{ar:"شريك استراتيجي",en:"Strategic Partner"},icon:"🏥"},
    {id:5,name:{ar:"التطوير والبناء",en:"Development & Build"},type:{ar:"شريك عمليات",en:"Operations Partner"},icon:"🏗"}
  ],
  services:[
    {id:1,name:{ar:"النقل واللوجستيات",en:"Transportation & Logistics"},desc:{ar:"نقل موثوق وسريع بين مدن المملكة مع تتبع لحظي.",en:"Reliable and fast transportation across the Kingdom with real-time tracking."},icon:"🚛"},
    {id:2,name:{ar:"إدارة المستودعات",en:"Warehouse Management"},desc:{ar:"حلول تخزين متقدمة وإدارة مخزون فعالة.",en:"Advanced storage solutions and efficient inventory management."},icon:"🏭"},
    {id:3,name:{ar:"التوصيل للمرحلة الأخيرة",en:"Last-Mile Delivery"},desc:{ar:"خدمة توصيل سريعة وفعالة لجميع المناطق.",en:"Fast and efficient delivery service to all regions."},icon:"📦"},
    {id:4,name:{ar:"إدارة القوى العاملة",en:"Workforce Management"},desc:{ar:"توفير كوادر احترافية مؤهلة بعناية.",en:"Providing carefully qualified professional workforce."},icon:"👥"},
    {id:5,name:{ar:"المرونة التشغيلية",en:"Operational Flexibility"},desc:{ar:"نماذج عمل مرنة تتكيف مع احتياجات عملك.",en:"Flexible work models that adapt to your changing business needs."},icon:"🔄"},
    {id:6,name:{ar:"التقارير والتحليلات",en:"Reports & Analytics"},desc:{ar:"تقارير دورية وتحسين مستمر للعمليات.",en:"Periodic reports and continuous process improvement."},icon:"📊"}
  ],
  nid:20
};

// ═══ LANG / THEME ═══
let lang = 'ar', theme = 'dark';
function toggleLang(){
  lang = lang==='ar'?'en':'ar';
...
function renderJobsWeb(){
  ...
  el.innerHTML=DB.jobs.map((j,i)=>`<div class="job-card rv d${(i%4)+1}" onclick="goSec('#contact-s')"><div class="job-left"><div class="job-ic">${j.icon}</div><div><div class="job-title">${t(j.title)}</div><div class="job-meta">${t(j.dept)} · ${t(j.loc)}</div><div class="job-tags"><span class="job-tag">${t(j.type)}</span><span class="job-tag">${t(j.loc)}</span></div></div></div><div class="job-right"><div class="job-sal">${t(j.salary)}</div><button class="btn-cta" style="font-size:12px;padding:8px 16px;"><span data-ar>قدّم الآن</span><span data-en>Apply Now</span></button></div></div>`).join('');
}
function renderGalList(){
  const el=document.getElementById('gallery-list');if(!el)return;
  el.innerHTML=DB.gallery.map(g=>`<div class="ir"><div class="ir-l"><div class="ithumb">${g.img?`<img src="${g.img}">`:`${g.icon}`}</div><div><div class="itit">${t(g.title)}</div><div class="imeta">${g.cat}</div></div></div><div class="ia"><button class="ib d" onclick="delItem('gallery',${g.id})">🗑️</button></div></div>`).join('');
}
...
function renderPtnList(){
  ...
  el.innerHTML=DB.partners.map(p=>`<div class="ir"><div class="ir-l"><div class="ithumb">${p.icon}</div><div><div class="itit">${t(p.name)}</div><div class="imeta">${t(p.type)}</div></div></div><div class="ia"><button class="ib" onclick="editPtn(${p.id})">✏️</button><button class="ib d" onclick="delItem('partners',${p.id})">🗑️</button></div></div>`).join('');
}
function renderPtnWeb(){
  const el=document.getElementById('ptn-display');if(!el)return;
  el.innerHTML=DB.partners.map((p,i)=>`<div class="ptn-card rv d${(i%5)+1}"><span class="ptn-logo">${p.icon}</span><div class="ptn-name">${t(p.name)}</div><div class="ptn-type">${t(p.type)}</div></div>`).join('');
}
...
function saveJob(){
  ...
  closeMo('job-mo');renderAll();toast('✅ تم حفظ الوظيفة');clearF(['job-eid','job-tit','job-dep','job-loc','job-sal','job-ic']);
}
function editJob(id){const j=DB.jobs.find(x=>x.id===id);if(!j)return;document.getElementById('job-eid').value=id;document.getElementById('job-tit').value=t(j.title);document.getElementById('job-dep').value=t(j.dept);document.getElementById('job-loc').value=t(j.loc);document.getElementById('job-tp').value=t(j.type);document.getElementById('job-sal').value=t(j.salary);document.getElementById('job-ic').value=j.icon;openMo('job-mo');}
function saveGal(){
  ...
  obj.id=DB.nid++;DB.gallery.push(obj);
  closeMo('gal-mo');renderAll();toast('✅ تمت إضافة الصورة');resetUp('gal-up','gal-prev','gal-img');clearF(['gal-tit','gal-ic']);
}
function savePtn(){
  const eid=document.getElementById('ptn-eid').value;
  const obj={name:{ar:document.getElementById('ptn-nm').value,en:document.getElementById('ptn-nm').value},type:{ar:document.getElementById('ptn-tp').value,en:document.getElementById('ptn-tp').value},icon:document.getElementById('ptn-ic').value||'🏢'};
  if(!obj.name.ar)return toast('⚠️ أدخل الاسم');
  ...
  closeMo('ptn-mo');renderAll();toast('✅ تم حفظ الشريك');clearF(['ptn-eid','ptn-nm','ptn-tp','ptn-ic']);
}
function editPtn(id){const p=DB.partners.find(x=>x.id===id);if(!p)return;document.getElementById('ptn-eid').value=id;document.getElementById('ptn-nm').value=t(p.name);document.getElementById('ptn-tp').value=t(p.type);document.getElementById('ptn-ic').value=p.icon;openMo('ptn-mo');}
function saveSvc(){
...
window.addEventListener('load',()=>{
  ...
  renderAll();
  setTimeout(()=>{document.getElementById('loader').classList.add('out');initRv();},2100);
});
