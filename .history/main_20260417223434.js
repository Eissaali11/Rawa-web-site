...
const DB={
  ...
  jobs:[
    {id:1,title:{ar:"مشرف مستودعات",en:"Warehouse Supervisor"},dept:{ar:"العمليات",en:"Operations"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},icon:"🏭"},
    {id:2,title:{ar:"سائق توصيل",en:"Delivery Driver"},dept:{ar:"التوصيل",en:"Delivery"},loc:{ar:"جدة",en:"Jeddah"},type:{ar:"دوام كامل",en:"Full-time"},icon:"🚚"},
    {id:3,title:{ar:"منسق لوجستي",en:"Logistics Coordinator"},dept:{ar:"اللوجستيات",en:"Logistics"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},icon:"📋"},
    {id:4,title:{ar:"مسؤول موارد بشرية",en:"HR Officer"},dept:{ar:"الموارد البشرية",en:"HR"},loc:{ar:"الرياض",en:"Riyadh"},type:{ar:"دوام كامل",en:"Full-time"},icon:"👥"}
  ],
  gallery:[
