...
const DB={
  ...
  testimonials:[
    {id:1,name:{ar:"محمد العتيبي",en:"Mohammed Al-Otaibi"},position:{ar:"مدير العمليات - شركة تصنيع",en:"Operations Director - Manufacturing Co."},text:{ar:"ساهمت رعاية في تحسين سلسلة الإمداد لدينا بشكل كبير، مما أدى إلى توفير التكاليف وزيادة الإنتاجية.",en:"Riaya significantly improved our supply chain, resulting in cost savings and increased productivity."},stars:5,icon:"👨‍💼",img:""},
    {id:2,name:{ar:"فهد الشمري",en:"Fahad Al-Shammari"},position:{ar:"الرئيس التنفيذي - شركة توزيع",en:"CEO - Distribution Company"},text:{ar:"فريق احترافي وحلول فعالة في الوقت المناسب. نقدر التزامهم بالجودة والسلامة في كل عملية.",en:"Professional team with timely solutions. We appreciate their commitment to quality and safety in every operation."},stars:5,icon:"👨‍💼",img:""}
  ],
  ...
  socialMedia:[
    ...
    {id:3,platform:"instagram",url:"#",icon:"📷",label:"Instagram"}
  ],
  nid:20
};
