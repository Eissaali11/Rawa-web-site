...
function savePrj(){
  ...
  closeMo('prj-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ المشروع');resetUp('prj-up','prj-prev','prj-img');clearF(['prj-eid','prj-name','prj-desc','prj-client','prj-dur','prj-ic']);
}
...
function saveNews(){
  ...
  closeMo('news-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الخبر');resetUp('news-up','news-prev','news-img');clearF(['news-eid','news-tit','news-exc','news-dt','news-ic']);
}
...
function saveTeam(){
  ...
  closeMo('team-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ العضو');clearF(['team-eid','team-nm','team-rl','team-bio','team-ic']);resetUp('team-up','team-prev','team-img');
}
...
function saveJob(){
  ...
  closeMo('job-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الوظيفة');clearF(['job-eid','job-tit','job-dep','job-loc','job-ic']);
}
...
function saveGal(){
  ...
  closeMo('gal-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الصورة');resetUp('gal-up','gal-prev','gal-img');clearF(['gal-eid','gal-tit','gal-ic']);
}
function savePtn(){
  ...
  closeMo('ptn-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الشريك');clearF(['ptn-eid','ptn-nm','ptn-tp','ptn-ic']);if(document.getElementById('ptn-img'))resetUp('ptn-up','ptn-prev','ptn-img');
}
...
function saveSvc(){
  ...
  closeMo('svc-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الخدمة');clearF(['svc-eid','svc-nm','svc-dc','svc-ic']);
}
...
function saveTest(){
  ...
  closeMo('test-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ التقييم');clearF(['test-eid','test-nm','test-pos','test-txt','test-ic']);if(document.getElementById('test-img'))resetUp('test-up','test-prev','test-img');
}
...
function saveContact(){
  ...
  renderContactWeb();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ بيانات التواصل');
}
...
function saveSocial(){
  ...
  closeMo('social-mo');renderAll();toast('<i class=''fa-solid fa-circle-check''></i> تم حفظ الرابط');clearF(['social-eid','social-plat','social-url','social-ic','social-lbl']);
}
...
function delItem(type,id){if(!confirm(lang==='ar'?'هل أنت متأكد من الحذف؟':'Are you sure you want to delete?'))return;DB[type]=DB[type].filter(i=>i.id!==id);renderAll();toast('<i class='fa-solid fa-trash-can'></i> '+(lang==='ar'?'تم الحذف':'Deleted'));}
